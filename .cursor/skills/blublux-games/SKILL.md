...
Six puzzle games from **one Phaser 4 + Capacitor monorepo** over two pure-model engines. Authority for stack, ads, CI/CD, and production checklist: **phaser4-game-factory** (`.cursor/skills/phaser4-game-factory/`). Orchestration spec: `docs/2026-06-27_blublux-games_*.md`.
...
4. `.cursor/skills/phaser4-game-factory/SKILL.md` + `references/00..05`
...
- **Orchestrator** (primary): `.cursor/skills/blublux-orchestrator/` or `/blublux-orchestrator` command
